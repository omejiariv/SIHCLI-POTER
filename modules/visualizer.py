            ...
            if dem_path:
                with st.spinner(f"Calculando tendencias y proyectando precipitación para +{years_future} años..."):
                    ...
                    if classified_raster_future is not None:
                         ...
                         # (Copy and paste the heatmap visualization block from display_life_zones_tab here)
                         # Replace 'classified_raster' with 'classified_raster_future'
                         # Replace 'output_profile' with 'output_profile_future'
                         # Replace 'name_map' with 'name_map_future'
