...
def display_spatial_distribution_tab(gdf_filtered, df_long, gdf_municipios, gdf_subcuencas, gdf_predios=None, user_loc, region="Antioquia", interpolacion="No", **kwargs):
